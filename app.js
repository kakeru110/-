...
const CATEGORIES = {
  male: [
    { key: "income", label: "年収", type: "income", cap: 33, max: 33, k: 700, unit: "万円", plausible: [0, 10000], group: "status" },
    { key: "job", label: "職業・雇用形態", type: "discrete", max: 9, tiers: MALE_JOB_TIERS, group: "status" },
    { key: "education", label: "学歴", type: "discrete", max: 5, tiers: MALE_EDUCATION_TIERS, group: "status" },
    { key: "personality", label: "性格・コミュ力", type: "slider", max: 18, labels: PERSONALITY_LABELS, group: "personality" },
    { key: "height", label: "身長", type: "heightAsc", max: 14, floor: 3, anchor: 150, k: 15, unit: "cm", plausible: [150, 200], group: "physical" },
    { key: "appearance", label: "顔立ち", type: "slider", max: 11, labels: APPEARANCE_LABELS, group: "physical" },
    { key: "body", label: "体型", type: "slider", max: 10, labels: BODY_LABELS, group: "physical" },
  ],
  female: [
    { key: "income", label: "年収", type: "income", cap: 11, max: 11, k: 500, unit: "万円", plausible: [0, 10000], group: "status" },
    { key: "job", label: "職業・雇用形態", type: "discrete", max: 10, tiers: FEMALE_JOB_TIERS, group: "status" },
    { key: "personality", label: "性格・家庭的な面", type: "slider", max: 24, labels: PERSONALITY_LABELS, group: "personality" },
    { key: "appearance", label: "顔立ち", type: "slider", max: 28, labels: APPEARANCE_LABELS, group: "physical" },
    { key: "body", label: "体型", type: "slider", max: 19, labels: BODY_LABELS, group: "physical" },
    { key: "height", label: "身長", type: "gaussian", max: 8, floor: 3, peak: 158, sigma: 12, unit: "cm", plausible: [140, 185], group: "physical" },
  ],
};

const CATEGORY_GROUPS = [
  { key: "status", label: "ステータス" },
  { key: "personality", label: "人柄" },
